# Generative AI Learning Path (Offline Bundle)

> This file concatenates all module content for convenient offline reading or PDF export.

{% for module in [
    "01_Introduction_to_GenAI.md",
